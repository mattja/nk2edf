...
/************************* write EDF-header ***************************************/
  ...
  if(edfplus)
  {
    ...
    else
    {
      ...
      switch(temp)
      {
        case  1 : fwrite("JAN", 3, 1, outputfile);
                  break;
        case  2 : fwrite("FEB", 3, 1, outputfile);
                  break;
        case  3 : fwrite("MAR", 3, 1, outputfile);
                  break;
        case  4 : fwrite("APR", 3, 1, outputfile);
                  break;
        case  5 : fwrite("MAY", 3, 1, outputfile);
                  break;
        case  6 : fwrite("JUN", 3, 1, outputfile);
                  break;
        case  7 : fwrite("JUL", 3, 1, outputfile);
                  break;
        case  8 : fwrite("AUG", 3, 1, outputfile);
                  break;
        case  9 : fwrite("SEP", 3, 1, outputfile);
                  break;
        case 10 : fwrite("OCT", 3, 1, outputfile);
                  break;
        case 11 : fwrite("NOV", 3, 1, outputfile);
                  break;
        case 12 : fwrite("DEC", 3, 1, outputfile);
                  break;
        default : fwrite("JAN", 3, 1, outputfile);
                  error = 1;
                  break;
      }
      p += 3;
